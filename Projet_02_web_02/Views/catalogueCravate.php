...
<head>
    ...
    <link rel="stylesheet" href="./Style/style_catalogue_cravate.css">
...
<body>
            ...
            ?>
                ...
                <style>
                    ...
                    nav > ul > li:hover > .sous_catalogue > li {
                        /* From https://css.glass */
                        background: rgba(26, 66, 50, 0.27);
                    }

                    .cravates:hover, .chemises:hover {
                        /* From https://css.glass */
                        background: rgba(50, 72, 63, 0.27);
                        border-radius: 16px;
                        box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);
                        backdrop-filter: blur(6.1px);
                        -webkit-backdrop-filter: blur(6.1px);
    ...
    <?php
        ...
        $catalogue->chargerProduits("Cravate");
        //print_r($catalogue);
        $carouselData = [] ;
        $i = 1;
    ...
    <script>
        ...
        setupCarousel() {
            ...
            const produitUrl = `/Project_Web_2/Projet_02_web_02/Views/produit.php?id_produit=${item.id_produit}&page=3`;
