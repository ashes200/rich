...
<body>
            ...
            ?>
                ...
                <style>
                    ...
                    nav > ul > li:hover > .sous_catalogue > li {
                        /* From https://css.glass */
                        background: rgba(57, 41, 71, 0.27);
                    }
                    footer, select {
                        /* From https://css.glass */
                        background: rgba(60, 32, 84, 0.27);
                    }
                    .cravates:hover, .chemises:hover {
                        /* From https://css.glass */
                        background: rgba(64, 55, 73, 0.27);
                        border-radius: 16px;
                        box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);
                        backdrop-filter: blur(6.1px);
                        -webkit-backdrop-filter: blur(6.1px);
    ...
    <script>
        ...
        setupCarousel() {
            ...
            const produitUrl = `/Project_Web_2/Projet_02_web_02/Views/produit.php?id_produit=${item.id_produit}&page=1`;
